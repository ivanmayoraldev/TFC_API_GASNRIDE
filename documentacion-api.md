...
- # URL: '/companias'
- # Método: 'GET'
- # Filtros: por el campo idcompania y nombre_comp
...
- # URL: '/municipios'
- # Método: 'GET'
- # Filtros: por idmunicipio, nombre, codigo_Territorial y numero de gasolineras
...
- # URL: '/gasolineras'
- # Método: 'GET'
- # Filtros por IDs (idgasolinera, idMunicipioFK, idCompaniaFK), por el nombre de gasolinera y filtro por precio exacto de combustibles
...
- # URL: '/puntos_interes'
- # Método: 'GET'
- # Filtros por idpunto_interes, nombre, tipo y idmunicipio_fk
